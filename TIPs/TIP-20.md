...
* Airdrop of 137 will be made available on l2 to all that didnt claim it already
* All ongoing rewards are migrated to L2 using the same contract (ongoing airdrop)
