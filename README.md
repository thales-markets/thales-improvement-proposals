...
| TIP-2  | [Formalizing technical agenda items for Thales - Contracts deployment](TIPs/TIP-2.md) | Implemented |
| TIP-3  | [Adding the Tether (USDT) price feed from Chainlink to Thales and enable USDT market creation](TIPs/TIP-3.md) | Implemented |
| TIP-4  | [Formalizing tokenomics model of Thales governance token](TIPs/TIP-4.md) | Implemented |
| TIP-5  | [Creating budget for marketing product growth and driving THALES liquidity](TIPs/TIP-5.md) | Implemented |
| TIP-6  | [THALES distribution ratio between L1 and L2 SNX stakers dynamically](TIPs/TIP-6.md) | Implemented |
| TIP-7  | [THALES single side staking](TIPs/TIP-7.md) | Implemented |
| TIP-8  | [Replacement of Synthetix ExchangeRates, Removal of minting fees and  adding allowance to 0x exchange contract](TIPs/TIP-8.md) | Implemented |
| TIP-9  | [CC's THALES token allocation and respective rules](TIPs/TIP-9.md) | Implemented |
| TIP-10 | [THALES token voting power and Second Thales Council elections](TIPs/TIP-10.md) | Implemented |
| TIP-11 | [AMM implementation to ensure initial liquidity on L2 layer](TIPs/TIP-11.md) | Implemented |
| TIP-12 | [Deployment of Thales protocol on Optimism Mainnet](TIPs/TIP-12.md) | Implemented |
| TIP-13 | [Thales Royale mainnet rollout](TIPs/TIP-13.md) | Implemented |
| TIP-14 | [Thales Royale Private Rooms mainnet rollout](TIPs/TIP-14.md) | Implemented |
| TIP-15 | [Adapting Thales AMM maximum skew impact](TIPs/TIP-15.md) |  Implemented |
| TIP-16 | [Utilization of Thales NFTs](TIPs/TIP-16.md) | Implemented |
| TIP-17 | [Gamified THALES approach on L2](TIPs/TIP-17.md) | Implemented |
| TIP-18 | [Pausing SNX based distribution](TIPs/TIP-18.md) | Implemented |
| TIP-19 | [Changes on AMM after First round](TIPs/TIP-19.md) | Implemented |
| TIP-20 | [Thales token migration to L2](TIPs/TIP-20.md) | Implemented |
| TIP-21 | [TWAP Price Feeds deployment](TIPs/TIP-21.md) | Implemented |
| TIP-22 | [Extension of THALES/ETH LP rewards on DODO](TIPs/TIP-22.md) | Implemented |
| TIP-23 | [Migration to Optimism with an incentivized THALES/ETH G-UNI pool](TIPs/TIP-23.md) | Implemented |
| TIP-24 | [Replacemant of Thales Council NFT from Orilla to ramblers99](TIPs/TIP-24.md) | Implemented |
| TIP-25 | [Integration of AAVE, SOL and UNI as available assets on Thales](TIPs/TIP-25.md) | Implemented |
| TIP-26 | [Integration of CRV as available asset on Thales](TIPs/TIP-26.md) | Implemented |
| TIP-27 | [Default positioning for Thales Royale and allow Protocol DAO to sign in addresses sponsored by the Treasury DAO](TIPs/TIP-27.md) | Implemented |
| TIP-28 | [Optimistic Exotic Positional Markets](TIPs/TIP-28.md) | Implemented |
